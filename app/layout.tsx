...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "finance professional development online",
    "investment banking training senior",
    "senior finance training online",
    "shariah compliant finance course",
...
const orgSchema = {
  ...
  knowsAbout: [
    ...
    "Islamic Finance", "Sukuk", "Shariah-Compliant Structuring", "Due Diligence",
    "Distressed M&A", "Corporate Restructuring", "Venture Capital",
  ],
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    ...
    itemListElement: [
      ...
      },
      {
        ...
        description: "A practitioner's guide to Sukuk structuring, Murabaha, Ijarah, Islamic private equity, and AAOIFI-aligned governance across 10 modules. GCC, UK, Malaysian, and Indonesian capital markets. In development.",
      },
    ],
  },
};
