...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Executive Finance Academy terms of use.",
      ...
      <section className="section-pad section-light">
        <div className="container" style={{ maxWidth: "720px" }}>
          ...
          <p className="section-body" style={{ marginBottom: "20px" }}>
            The Terms of Use for Executive Finance Academy are currently being finalised and will be published
            prior to the full public launch of the platform.
          </p>
          <p className="section-body">
            For any queries regarding terms of access or programme usage, please contact us at{" "}
            <a
