...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Is group or corporate licensing available?", acceptedAnswer: { "@type": "Answer", text: "Yes. Executive Finance Academy offers group licensing for teams of three or more. Contact hello@executivefinanceacademy.com or use the enrol page enquiry form for group pricing and custom cohort options." } },
  ],
};
