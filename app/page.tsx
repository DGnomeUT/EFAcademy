...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "What is Executive Finance Academy?", acceptedAnswer: { "@type": "Answer", text: "Executive Finance Academy is an online finance education platform built by practitioners for senior finance professionals. It offers practitioner-authored courses on real world tokenization, Islamic finance, private equity, M&A, leveraged finance, and more — designed for CFOs, fund managers, principals, and senior investment professionals operating across global capital markets." } },
    { "@type": "Question", name: "Who are Executive Finance Academy courses designed for?", acceptedAnswer: { "@type": "Answer", text: "Senior finance professionals — CFOs, principals, fund managers, investment directors, general counsels, and board advisors — who need executable technical knowledge for live transactions. Courses are written at deal-room altitude, not analyst training level." } },
    { "@type": "Question", name: "What courses does Executive Finance Academy currently offer?", acceptedAnswer: { "@type": "Answer", text: "The live programme is Real World Tokenization, available at Foundation ($500, 8 modules) and Executive ($1,250, 16 modules, 46 video lessons) tiers. Islamic Finance & Shariah-Compliant Structuring is in development. Private Equity, M&A Execution, Private Credit, Distressed M&A, Financial Modelling, Due Diligence, and Venture Capital programmes are also in development." } },
    { "@type": "Question", name: "What is the Real World Tokenization course?", acceptedAnswer: { "@type": "Answer", text: "Real World Tokenization is an online finance certification for senior professionals covering the institutional framework for tokenising private assets — private equity, real estate, infrastructure, and private credit. It covers blockchain architecture, smart contract design, regulatory frameworks across UK (FCA), US (SEC), EU (MiFID II), Singapore (MAS), Hong Kong (SFC), and Gulf (DIFC/ADGM) markets, plus live deal case studies. Foundation is $500 (8 modules); Executive is $1,250 (16 modules, 46 video lessons)." } },
    { "@type": "Question", name: "Does Executive Finance Academy offer an Islamic finance course?", acceptedAnswer: { "@type": "Answer", text: "Yes. Islamic Finance & Shariah-Compliant Structuring is currently in development — a practitioner's guide to Sukuk structuring, Murabaha, Ijarah, Wakala, Islamic private equity, and AAOIFI-aligned governance across 10 modules. It covers GCC, UK, Malaysian, and Indonesian capital markets. Register interest at executivefinanceacademy.com/courses/islamic-finance for early-access pricing." } },
    { "@type": "Question", name: "How do Executive Finance Academy courses compare to business school executive education?", acceptedAnswer: { "@type": "Answer", text: "Business school executive programmes (LBS, INSEAD, Wharton) deliver broad management frameworks — campus-based, cohort-paced, and priced in the thousands. Executive Finance Academy is engineered for a different need: deep, specialised, technical finance training available on demand from $500, authored by active practitioners, and applicable to live transactions the same week it is completed." } },
    { "@type": "Question", name: "Is group or corporate licensing available?", acceptedAnswer: { "@type": "Answer", text: "Yes. Executive Finance Academy offers group licensing for teams of three or more. Contact theexecutivefinanceacademy@gmail.com or use the enrol page enquiry form for group pricing and custom cohort options." } },
  ],
};
